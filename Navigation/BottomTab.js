...
const BottomTab = () => {
    return (
        <Tab.Navigator tabBarOptions={options}>
            <Tab.Screen name='Home' component={Home} options={{tabBarIcon:({focused,color,size}) => getIcon(focused,color,"Home")}} />
            <Tab.Screen name='Search' component={Search} options={{tabBarIcon:({focused,color,size}) => getIcon(focused,color,"Search")}} />
        </Tab.Navigator>
    )
}
